...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        <p class="font-rale font-size-12 text-black-50 m-0"><?php echo 'Welcome ' ;?></p>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#top-sale-">Top-Selling</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#indian-reading-">Indian-Reading</a>
                </li>
                <li class="nav-item">
            ...
            <form action="#" class="font-size-14 font-rale">
                <a href="cart.php" class="py-2 rounded-pill color-primary-bg">
                    ...
                    <span class="px-3 py-2 rounded-pill text-dark bg-light"><?php $db = new DBController();
