...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img id="tsb2" src="<?php echo $item['item_image'] ?? "./assets/products/1.png" ?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">GS Books </a>(4.5 out of 5 | 18,198 ratings)</small>
            ...
            <div class="col-12">
                <br><br><br><br>
                <h6 class="font-rubik">Book Description</h6>
                <hr>
